...
register_bitfields! {u64,
    pub ESR_EL2 [
        ...
        EC  OFFSET(26) NUMBITS(6) [
            ...
            TrappedVMRSAccess = 0b00_1000,
            /// Trapped use of a Pointer authentication instruction (FEAT_PAuth)
            TrappedPointerAuth = 0b00_1001,
            /// Trapped execution of LS64, SPE, or TRBE related instruction (FEAT_LS64/FEAT_SPEv1p5/FEAT_TRBEv1p1)
            TrappedLS64_SPE_TRBE = 0b00_1010,
