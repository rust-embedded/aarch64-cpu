...
//! PRBAR_EL2 - Protection Region Base Register
//!
...
register_bitfields! {u64,
    pub PRBAR_EL2 [
        ...
        AP OFFSET(2) NUMBITS(2) [
            ReadWriteAtEl2Only = 0b00,
            ReadWriteAtAnyEl = 0b01,
            ReadOnlyAtEl2 = 0b10,
            ReadOnlyAtAnyEl = 0b11,
        ],
...
impl Reg {
    pub fn base_addr(&self) -> *const u8 {
        ((self.read(PRBAR_EL2::Base) as usize) << 6) as *const u8
    }
}

impl Readable for Reg {
    type T = u64;
    type R = PRBAR_EL2::Register;

    sys_coproc_read_raw!(u64, "PRBAR_EL2", "x");
}
...
impl Writeable for Reg {
    ...
    sys_coproc_write_raw!(u64, "PRBAR_EL2", "x");
}

pub const PRBAR_EL2: Reg = Reg {};
